...
library PaymentLib {
    ...
    /**
     * @dev Return a number between 0 - 200 to scale the donation based on the
     ...
     */
    function getPaymentWithModifier(
        PaymentData storage self,
    ...
    /**
     * @dev Validation: ensure that the request endowment is sufficient to cover.
